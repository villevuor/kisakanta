...
function get_header() {
	...
	<html class="no-js" lang="fi">
		<head>
			...
			<link rel="mask-icon" href="/assets/favicon/safari-pinned-tab.svg" color="#008c65">
			<link rel="shortcut icon" href="/assets/favicon/favicon.ico">
			<meta name="apple-mobile-web-app-title" content="Kisakanta">
			<meta name="application-name" content="Kisakanta">
